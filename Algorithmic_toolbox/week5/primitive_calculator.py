'''
Bài toán máy tính nguyên thủy 
Tìm số phép toán tối thiểu cần thiết để có được số nguyên dương n từ 1 bằng cách chỉ sử dụng ba phép toán: cộng 1, nhân với 2 và nhan với 3.
Input: An integer n.
